...
fn register_model<'p>(
    ...
    pyo3_async_runtimes::tokio::future_into_py(py, async move {
        ...
        // Some loaders, such as vLLM ModelExpress P2P, already have weights in engine memory
        // but still need tokenizer/config metadata for the ModelDeploymentCard.
